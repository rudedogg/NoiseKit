...
open class AHNContext: NSObject {
  ...
  private init(device: MTLDevice?) {
    ...
    grad3Buffer = device.makeBuffer(bytes: &grad3, length: MemoryLayout<SIMD3<Float>>.size * grad3.count, options: MTLResourceOptions.storageModeShared)!

    var grad4 = [SIMD4<Float>(0, 1, 1, 1), SIMD4<Float>(0, 1, 1, -1), SIMD4<Float>(0, 1, -1, 1), SIMD4<Float>(0, 1, -1, -1), SIMD4<Float>(0, -1, 1, 1), SIMD4<Float>(0, -1, 1, -1), SIMD4<Float>(0, -1, -1, 1), SIMD4<Float>(0, -1, -1, -1), SIMD4<Float>(1, 0, 1, 1), SIMD4<Float>(1, 0, 1, -1), SIMD4<Float>(1, 0, -1, 1), SIMD4<Float>(1, 0, -1, -1), SIMD4<Float>(-1, 0, 1, 1), SIMD4<Float>(-1, 0, 1, -1), SIMD4<Float>(-1, 0, -1, 1), SIMD4<Float>(-1, 0, -1, -1), SIMD4<Float>(1, 1, 0, 1), SIMD4<Float>(1, 1, 0, -1), SIMD4<Float>(1, -1, 0, 1), SIMD4<Float>(1, -1, 0, -1), SIMD4<Float>(-1, 1, 0, 1), SIMD4<Float>(-1, 1, 0, -1), SIMD4<Float>(-1, -1, 0, 1), SIMD4<Float>(-1, -1, 0, -1), SIMD4<Float>(1, 1, 1, 0), SIMD4<Float>(1, 1, -1, 0), SIMD4<Float>(1, -1, 1, 0), SIMD4<Float>(1, -1, -1, 0), SIMD4<Float>(-1, 1, 1, 0), SIMD4<Float>(-1, 1, -1, 0), SIMD4<Float>(-1, -1, 1, 0), SIMD4<Float>(-1, -1, -1, 0)]
    grad4Buffer = device.makeBuffer(bytes: &grad4, length: MemoryLayout<SIMD4<Float>>.size * grad4.count, options: .storageModeShared)!
